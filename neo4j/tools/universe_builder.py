...
EPILOGUE_STRING = "In addition, environment variables named 'NEO4J_SOME_PARAMETER' " \
                "will be inserted against the provided package neo4j (with params of the " \
                " form '{{some-parameter}}')"
...
def main(argv):
    ...
    parser.add_argument('package_dir_path', type=str,
                        help='The local path where the package neo4j is located')
